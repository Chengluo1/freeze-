                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <s:if test="#request.showComments.size()!=0">
                                    <s:iterator value="#request.showComments" var="detail">
                                                <tr>
                                                    <td>
                                                        <h4>
                                                            <b><s:property value="CommentsID"/></b>
                                                        </h4>
                                                    </td>
                                                    <td>
                                                        <h4>
                                                            <b><s:property value="account"/></b>
                                                        </h4>
                                                    </td>
                                                    <td>
                                                        <h4>
                                                            <b><s:property value="#request.exampleID"/></b>
                                                        </h4>
                                                    </td>
                                                    <td>
                                                        <h4>
                                                            <b><s:property value="content"/></b>
                                                        </h4>
                                                    </td>
                                                    <td>
                                                        <h4>
                                                            <b><s:property value="time"/></b>
                                                        </h4>
                                                    </td>
                                                    <s:if test="status!=1">
                                                        <td>
                                                        ...
                                                        <td>
                                                            <h4>
                                                            <a href="deleteComments.action?example.exampleId=<s:property value='#request.exampleID'/>&commentID=<s:property value='CommentsID'/>">不允许显示</a>
                                                            </h4>
                                                        </td>
                                                    </s:if>
                                                    <s:else>
                                                        ...
                                                        <td>
                                                            <h4>
                                                                <a href="allowComments.action?example.exampleId=<s:property value='#request.exampleID'/>&commentID=<s:property value='CommentsID'/>">允许显示</a>
                                                            </h4>
                                                        </td>
                                                    </s:else>
                                ...
                                <s:else>
                                    <tr>
                                        <td><a data-toggle="modal" data-target="#lessonDetailModal" style="cursor: pointer"><h1>当前案例没有用户评论哦</h1></a></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
