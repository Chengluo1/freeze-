...
public class NeedsAction {
    ...
    public String getNeedsByID(){
        ...
        System.out.println("----------------------------"+needs.getNeedsId()+" "+needs.getEmployer().getEmployerId());
        return "success";
    }
    ...
    public String SelectPho() throws Exception {
        return this.needsServ.selectPho(this.needs, this.photographer) ? "success" : "false";
    }
}
