    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-3 text-gray-800">我签单的项目</h1>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">签单列表</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <s:if test="%{#session.photographer!=null}">
                                    <s:iterator value="#session.photographer.orderrs">
                                        <tr>
                                            <td>
                                                <h4>
                                            ...
                                            <td>
                                                <h4>
                                                    <b><s:property value="money"/></b>
                                                </h4>
                                            </td>
                                            <td>
                                                <h4>
                                                    <b><s:date name="beginTime" format="yyyy-MM-dd HH:mm:ss"/></b>
                                                </h4>
                                            </td>
                                            <td>
                                                <h4>
                                                    <b><s:property value="state"/></b>
                                                </h4>
                                            </td>
                                            <td>
                                                <h4>
                                                    <b><a href="orderrByID.action?orderrId=<s:property value='orderrId' />"  target="_blank">查看详情</a></b>
                                                </h4>
                                            </td>
                                        </tr>
                                    </s:iterator>
                                ...
                                <s:elseif test="%{#session.employer!=null}">
                                    <s:iterator value="#session.employer.orderrs">
                                        ...
                                        <td>
                                            <h4>
                                                <b><a href="orderrByID.action?orderrId=<s:property value='orderrId'/>"   target="_blank">查看详情</a>
                                                    <s:if test="%{state.equals('已完成')}">
                                                        <a href="app.action?orderrId=<s:property value='orderrId'/>"  target="_blank">评论</a>
                                                    </s:if>
                                                </b>
                                            </h4>
                                        </td>
                            ...
                            <s:if test="%{#session.photographer!=null}">
                                <div>
                                    <a href="getApprise.action?photographerId=<s:property value='#session.photographer.photographerId'/> "  target="_blank">查看我收到的评论</a>
                                </div>
                            </s:if>
                        </div>
                    </div>
