            ...
            <div class="col-lg-12">
                <div class="heading-title text-center">
                    ...
                    <form action="searchInList" id="list_form" >
                            ...
                            <dl attr="terminal_os_s">
                                ...
                                <dd>
                                    <div class="righttitle">
                                        <label>
                                            <input name="radio2" type="radio" value="简约"autocomplete="off" />
                                            <a href="javascript:;">简约</a></label>
                                        <label>
                                            <input name="radio2" type="radio" value="时尚" autocomplete="off" />
                                            <a href="javascript:;">时尚</a></label>
                                        <label>
                                            <input name="radio2" type="radio" value="可爱" autocomplete="off" />
                                            <a href="javascript:;">可爱</a></label>
                                    </div>
                                </dd>
                            </dl>
                        </div>
                        ...
                        <button class="button button_border" name="butt"  >【按关键词搜索】</button>
                    </form>
                </div>
                <div class="heading-title text-center">
        ...
        <div class="tz-gallery">
            <div class="heading-title text-center">
                ...
                <form action="recommendyou" method="post">
                    <button name="butt" class="normal" >为你推荐</button>
                </form>
            </div>
            <div class="row">
                            ...
                            <div class="our-team">
                                <a href="putExample.action?example.exampleId=<s:property value='exampleId'/>">
                                    <s:iterator value="pictures" status="st">
                                        <div class="pic">
                                            <s:if test="%{#st.first==true}"><img src="<s:property value="picture1"/>" />
                                            </s:if>
                                            <s:else><img src="<s:property value="picture1"/>" />
                                            </s:else>
                                        </div>
                                    </s:iterator>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <h3>关于我们</h3>
                <p>XX约拍平台是由zcy，fyl，ch，clf，fym共同开发的约拍平台。</p>
            </div>
            <div class="col-lg-3 col-md-6">
                <h3>Subscribe</h3>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="lead">杭州市,西湖区,288号,浙江工地大学</p>
