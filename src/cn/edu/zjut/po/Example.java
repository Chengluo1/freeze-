...
public class Example {
 ...
 //   @check(maxLen = 20)
  ...
  //  @check(maxLen = 10)
    ...
    public Example(Integer exampleId, String name, String description, String style, Integer praise, Timestamp time, String area, Integer visits, String photographerId, Integer status, Set panoramas, Set pictures, Set comments, Set<Employer> em_collecters) {
