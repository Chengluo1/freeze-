    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            >
                ...
                <a class="navbar-brand" href="#">摄影师认证</a>
            </nav>
            <!-- End of Topbar -->

            <!-- Begin Page Content -->
            <div class="container-fluid">
                <h1 class="h3 mb-3 text-gray-800">上传摄影师资格证<span>${request.tip }</span></h1>
                <div class="card shadow mb-4">

                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">摄影师认证表单</h6>
                    </div>
                    <div class="card-body">
                            ...
                            <form action="update2" method="post" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <img src="photographer/photographer/certificate/${session.photographer.certificate}"  style="width: 800px;height: 400px"/>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label>证书与奖项：</label>
                                    <div>
                                        <textarea name="photographer.prize" placeholder="在这里写你获得过的奖项及证书哦">${session.photographer.prize}</textarea>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                        <button lay-submit="" lay-filter="demo1">申请认证</button>
                                    </div>
                                </div>
                            </form>
                        </div>
