            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">摄影师申请推优</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <s:if test="%{#session.photographer.status1==null}">
                                <form action="recommend1" method="post" enctype="multipart/form-data">
                                    <div>
                                        <div>
                                            <button  lay-submit="" lay-filter="demo1">点击此报名申请个人推优</button>
                                        </div>
                                    </div>
                                </form>
                            </s:if>
                            <s:elseif test="%{#session.photographer.status1==2}">
