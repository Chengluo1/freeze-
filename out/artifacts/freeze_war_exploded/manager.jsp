    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            >
                ...
                <a class="navbar-brand" href="#">摄影师推优</a>
            </nav>
            <!-- End of Topbar -->

            <!-- Begin Page Content -->
            <div class="container-fluid">
                <h1 class="h3 mb-3 text-gray-800">摄影师列表</h1>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">摄影师推优情况列表</h6>
                    </div>
                            ...
                            >
                                ...
                                <s:if test="#session.Photographerss.size()!=0">
                                    <s:iterator value="#session.Photographerss" var="photographer">
                                        <s:if test="#photographer.status1!=null  && (#photographer.status1.intValue()==1  || #photographer.status1.intValue()==2)">
                                            <tr>
                                                <td>
                                                    <h4>
                                                ...
                                                <td>
                                                    <a href="putPhotographer.action?photographer.photographerId=${photographer.photographerId}">查看摄影师详情</a>
                                                </td>
                                                <td><s:if test="status1.intValue()==1">
                                                    <div>
                                                        <a
                                                                href="recommendP.action?photographer.photographerId=<s:property value='photographerId'/>"><font
                                                                color="red">推优</font></a>
                                                    </div>
                                                </s:if>
