    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-3 text-gray-800">我发布的需求</h1>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">需求列表</h6>
                    </div>
                    <div class="card-body">
                            ...
                            >
                                ...
                                <s:iterator value="#session.employer.needs">
                                    <tr>
                                        ...
                                        <td>
                                            <h4>
                                                <b><s:property value="enrollment"/></b>
                                            </h4>
                                        </td>
                                        <td>
                                            <h4>
                                                <b><a href="needsByID?needsId=<s:property value='needsId' />"  target="_top"  class="layui-btn layui-btn-mini layui-btn-normal">查看详情</a></b>
                                            </h4>
                                        </td>
                                    </tr>
                                </s:iterator>
