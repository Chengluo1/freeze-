    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-3 text-gray-800">已认证的摄影师列表</h1>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">摄影师信息列表</h6>
                    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <%
                                    ...
                                    List list = (List) session.getAttribute("photographerss");
                                    int k = list.size();
                                    for (int j = 0; j < k; j++) {
                                ...
                                <tr>
                                    <td>
                                        <h4>
                                            <b>${photographer.photographerId}</b>
                                        </h4>
                                    </td>
                                    <td>
                                        <h4>
                                    ...
                                    <td>
                                        <h4>
                                            <b>${photographer.IDNumber}</b>
                                        </h4>
                                    </td>
                                    <td>
                                        <h4>
                                            <b>${photographer.phone}</b>
                                        </h4>
                                    </td>
                                    <td>
                                        <a href="view.action?photographer.photographerId=${photographer.photographerId}">查看详情</a>
                                    </td>
                                </tr>
                                <%
                                    }
