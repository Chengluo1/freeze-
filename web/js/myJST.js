function testT(data) {
    ...
    Lcredit.setAttribute("value",result[2]);
    var CTLterm=document.getElementById("input-term");
    CTLterm.setAttribute("value",result[3]);
    var Ltype=document.getElementById("input-Ltype");
    Ltype.setAttribute("value",result[4]);
    var Lperiod=document.getElementById("input-Lperiod");
    Lperiod.setAttribute("value",result[5]);
    var Tname=document.getElementById("input-Tname");
    Tname.setAttribute("value",result[7]);
    var Cname=document.getElementById("input-Cname");
    Cname.setAttribute("value",result[8]);
    var modalT = $('#lessonDetailModal');
    modalT.modal('toggle');
}
