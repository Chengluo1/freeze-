    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-3 text-gray-800"><s:property value="#session.employer1.account" /></h1>
                <div>
                    <img src="photographer/employer/profilephoto/<s:property value="#session.employer.profilePhoto"/>" alt="" width="100" height="100"/>
                </div>
                <div>
                    <s:property value="#session.employer1.account" />
                    <s:if test="%{#session.employer1.sex==0}">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <s:iterator value="#session.employer1.needs">
                                    <tr>
                                        <td>
                                            <h4>
                        ...
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <tr>
                                    <td>
                                        <h4>
                                            <s:property value="#session.employer1.region" />
                                        </h4>
                                    </td>
                                    <td>
                                        <h4>
                                            <a href="mailto:example@gmail.com"><s:property
                                                    value="#session.employer1.email" /></a></a>
                                        </h4>
                                    </td>
                                    <td>
                                        <h4>
                                            <s:property value="#session.employer1.wechat" />
                                        </h4>
                                    </td>
                                    <td>
                                        <h4>
                                            <s:property value="#session.employer1.qq" />
                                        </h4>
                                    </td>
                                    <td>
                                        <h4>
                                            <s:property value="#session.employer1.phone" />
                                        </h4>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <p>
                                <s:property value="#session.employer1.introduction" />
                            </p>
                        </div>
                    </div>
                </div>
