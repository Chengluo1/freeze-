...
public class Orderr {
    ...
    public Orderr(String orderrId, String title, String description, Date beginTime, Date designTime, Date finishTime, Float money, String state, Employer employer, Photographer photographer) {
