...
<div class="sub-main-w3">
    <div class="form"><s:fielderror/>
        <s:form role="form" action="registerPho" method="post" class="registration-form" onsubmit="return custCheck()">
            <h2>注册
            ...
            <div class="form-style-agile">
                ...
                <s:textfield id="mobile" name="photographer.phone" />
            </div>
            <div class="form-style-agile">
                <label>
                ...
                <s:password name="photographer.password" id="pwd" />
            </div>
            <div class="form-style-agile">
                <label>
                    <i class="fas fa-unlock-alt"></i>
            ...
            <div class="wthree-text">
                <ul>
                    <li>
                        <label class="anim">
                            <span><a href="registerEmp.jsp">切换至用户注册！！</a></span>
                        </label>
                    </li>
                    <li>
                        <div class="link">
