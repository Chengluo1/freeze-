    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            >
                ...
                <a class="navbar-brand" href="#">申请推优</a>
            </nav>
            <div class="container-fluid">
                <h1 class="h3 mb-3 text-gray-800">案例申优</h1>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">申请案例推优</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <s:iterator value="#session.photographer.examples_own" var="example">
                                    <tr>
                                        <td>
                                            <h4>
                                                <b>
                                                    <a href="putExample.action?example.exampleId=<s:property value='#example.exampleId'/>">
                                                        <s:property value="#example.name"/>
                                                    </a>
                                                </b>
                                            </h4>
                                        </td>
                                        <td>
                                            <h4>
                                                <s:if test="%{#example.status==2}">
                                                    已推优
                                                </s:if>
                                                <s:elseif test="%{#example.status==1}">
                                                    您已申请推优，请耐心等待！
                                                </s:elseif>
                                                <s:else>
                                                    <a href="recommend3.action?exampleId=<s:property value='#example.exampleId'/>">申请推优</a>
                                                </s:else>
                                            </h4>
                                        </td>
                                    </tr>
